#almheb ®
#الملـف حقـوق وكتابـة ⤶ @X888E خاص بسـورس ⤶ almheb


#صدقـة جـاريـه لـروح المرحوم امير وروح جدي احمد
...
async def _(event):
    ...
    async with event.client.conversation(chat) as conv:
        try:
            ...
            await catevent.edit("**╮•⎚ تحـقق من انـك لم تقـم بحظر البوت @Zelovbot .. ثم اعـد استخدام الامـر ...🤖♥️**")
            return
