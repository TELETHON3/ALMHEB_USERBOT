...
async def cmds(almheb):
    await eor(almheb, Cmds)

########################  SOURCE almheb ~ BY: almheb (@E999G)  ########################
...
async def _(event):
    ...
    if input_str == "م1":
        ...
        if r == 0:
            await event.edit(
                "𓆰 [𝑺𝑶𝑼𝑹𝑪𝑬 almheb𝙏𝙃𝙊𝙉 - 𝑪𝑶𝑴𝑴𝑨𝑵𝑫𝑺](t.me/E999G) 𓆪\n **⌔╎قائـمه اوامر الادمن :** \n⪼ `.حظر` \n⪼ `.الغاء حظر` \n⪼ `.تقيد` \n⪼ `.الغاء تقيد` \n⪼ `.رفع القيود` \n⪼ `.كتم` \n⪼ `.الغاء كتم` \n⪼ `.تثبيت` \n⪼ `.الغاء التثبيت` \n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 almheb𝙏𝙃𝙊𝙉](t.me/E999G) 𓆪"
            )
        else:
            await event.edit(
                "𓆰 [𝑺𝑶𝑼𝑹𝑪𝑬 almheb𝙏𝙃𝙊𝙉 - 𝑪𝑶𝑴𝑴𝑨𝑵𝑫𝑺](t.me/E999G) 𓆪\n **⌔╎قائـمه اوامر الادمن :** \n⪼ `.حظر` \n⪼ `.الغاء حظر` \n⪼ `.تقيد` \n⪼ `.الغاء تقيد` \n⪼ `.رفع القيود` \n⪼ `.كتم` \n⪼ `.الغاء كتم` \n⪼ `.تثبيت` \n⪼ `.الغاء التثبيت` \n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 almheb𝙏𝙃𝙊𝙉](t.me/E999G) 𓆪"
...
########################  SOURCE almheb𝙏𝙃𝙊𝙉 ~ BY: almheb (@E999G)  ########################
...
async def _(almheb):
    await eor(almheb, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 almheb - 𝑪𝑶𝑴𝑴𝑨𝑵𝑫𝑺](t.me/E999G) 𓆪\n **⌔╎قائـمه اوامر الترحيب :** \n⪼ `.ترحيب ` \n⪼ `.حذف ترحيب ` \n⪼ `.الترحيب `\n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 almheb](t.me/E999G) 𓆪")
...
async def _(almheb):
    await eor(almheb, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 almheb - 𝑩𝑳𝑨𝑪𝑲𝑳𝑰𝑺𝑻](t.me/E999G) 𓆪\n **⌔╎القائمة السوداء :** \n⪼ `.منع كلمه + الكلمه ` لمنع كلمه  \n⪼ `.الغاء منع + الكلمه` \n⪼ `.الكلمات المحظوره` \n⪼ `.ازعاج` \n⪼ `.الغاء ازعاج` \n⪼ `.قائمة الازعاج` \n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 almheb](t.me/E999G) 𓆪")
...
async def _(almheb):
    await eor(almheb, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 almheb - 𝑫𝑬𝑽𝑬𝑳𝑶𝑷𝑬𝑹](t.me/E999G) 🧸♥️𓆪\n**𓍹━─━─━─━─almheb─━─━─━─━𓍻**\n **𓄂**╺  𝑫𝑬𝑽 ❶╰──► @E999G ༗\n\n **𓄂**╺  𝑫𝑬𝑽 ❷╰──► 𝒅𝒆𝒆𝒑 𝒘𝒐𝒖𝒏𝒅⍣°.²°²¹🦋… ༗\n\n **𓄂**╺  𝑫𝑬𝑽 ❸╰──► @HHHl1l ༗")
...
async def _(almheb):
    await eor(almheb, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 almheb - 𝘿𝙀𝙇𝙀𝙏𝙀](t.me/E999G) 🗑♻️𓆪\n**𓍹━─━─━─━─almheb─━─━─━─━𓍻**\n\n **✵│رابـط الحـذف ↬** https://telegram.org/deactivate \n\n\n **✵│بـوت الحـذف  ↬** @LC6BOT ")
...
async def almheb(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
    almhebth = user.first_name.replace("\u2060", "") if user.first_name else user.username
    almhebt = random.choice(kno)
    await edit_or_reply(mention, f"⌔╎نـسـبتكم انـت و [{almhebth}](tg://user?id={user.id}) هـي {almhebt} 😔🖤")
...
async def almheb(mention):
    ...
    if not user:
        return
    almhebth = user.first_name.replace("\u2060", "") if user.first_name else user.username
    almhebt = random.choice(arb)
    await edit_or_reply(mention, f"⌔╎نسبه الانوثه لـ [{almhebth}](tg://user?id={user.id}) هـي {almhebt} 🤰")
...
async def permalink(mention):
    ...
    almhebth = user.first_name.replace("\u2060", "") if user.first_name else user.username
    almhebt = random.choice(arb)
    await edit_or_reply(mention, f"⌔╎نسبه الغباء لـ [{almhebth}](tg://user?id={user.id}) هـي {almhebt} 😂💔")
...
async def permalink(mention):
    ...
    almhebth = user.first_name.replace("\u2060", "") if user.first_name else user.username
    almhebt = random.choice(arb)
    await edit_or_reply(mention, f"⌔╎نسبة الانحراف لـ [{almhebth}](tg://user?id={user.id}) هـي {almhebt} 🥵🖤")
...
async def permalink(mention):
    ...
    almhebth = user.first_name.replace("\u2060", "") if user.first_name else user.username
    almhebt = random.choice(arb)
    await edit_or_reply(mention, f"⌔╎نسبه المثليه لـ [{almhebth}](tg://user?id={user.id}) هـي {almhebt} 🤡 🏳️‍🌈.")
...
async def permalink(mention):
    ...
    almhebth = user.first_name.replace("\u2060", "") if user.first_name else user.username
    almhebt = random.choice(arb)
    await edit_or_reply(mention, f"⌔╎نسبه النجاح لـ [{almhebth}](tg://user?id={user.id}) هـي {almhebt} 🤓.") 
...
async def permalink(mention):
    ...
    almhebth = user.first_name.replace("\u2060", "") if user.first_name else user.username
    almhebt = random.choice(arb)
    await edit_or_reply(mention, f"⌔╎نسبه الكراهـي لـ [{almhebth}](tg://user?id={user.id}) هـي {almhebt} 🤮.")
...
async def almheb(mention):
    ...
    if not user:
        return
    almhebth2 = user.last_name.replace("\u2060", "") if user.last_name else user.username
    me = await mention.client.get_me()
    my_first = me.first_name
    my_mention = f"[{me.first_name}](tg://user?id={me.id})"
    await edit_or_reply(mention, f"**🚹 ╎ المستخدم ⪼ • ** [{almhebth2}](tg://user?id={user.id}) \n☑️ **╎ تم رفعـه ورع القـروب .. بنجـاح😹🙇🏻.** \n**🤵‍♂️ ╎ بواسطـه  :** {my_mention} ")
...
async def almheb(mention):
    ...
    my_first = me.first_name
    my_mention = f"[{me.first_name}](tg://user?id={me.id})"
    await edit_or_reply(mention, f"**🚺 ╎ المستخدمه ⪼ • ** [{almhebth2}](tg://user?id={user.id}) \n☑️ **╎ تم رفعـها مـزة الكروب .. بنجـاح 🥳💃.** \n**🤵‍♂️ ╎ بواسطـه  :** {my_mention} ")
...
DEFAULTUSER = "almheb"
CAT_IMG = "https://telegra.ph/file/4c406eb5e6932d4834947.jpg"
CUSTOM_ALIVE_TEXT = "𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 almheb - 𝑫𝑬𝑽??𝑳𝑶𝑷𝑬𝑹 𓆪"
EMOJI = "  𓄂† "
...
async def dev(alive):
    ...
    if CAT_IMG:
        ...
        cat_caption += f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧalmhebⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n"
        cat_caption += f"**{EMOJI}** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹 1 ↬ @X888E ༗\n"
        cat_caption += f"**{EMOJI}** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹 2 ↬ @E999G ༗\n"
        cat_caption += f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧalmhebⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻"
        ...
        await edit_or_reply(
            alive,
            f"**{CUSTOM_ALIVE_TEXT}**\n"
            f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧalmhebⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n"
            f"**{EMOJI}** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹 1 ↬ @X888E ༗\n"
            f"**{EMOJI}** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹 2 ↬ @E999G ༗\n"
            f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧalmhebⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻",
        )