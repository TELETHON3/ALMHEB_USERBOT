...
almheb_TEXT = Config.CUSTOM_ALIVE_TEXT or "╮•⎚ مـعلومات الـشخص مـن بـوت زدثـون"
almhebM = Config.CUSTOM_ALIVE_EMOJI or " •❃ "
...
async def fetch_info(replied_user, event):
    ...
    caption = f"<b> {almheb_TEXT} </b>\n"
    caption += f"<b> ٴ•━─━─━─━─━─━─━─━─━• </b>\n"
    caption += f"<b> {almhebM}| الاسـم    ⇦ </b> {first_name} {last_name}\n"
    caption += f"<b> {almhebM}| المعـرف  ⇦ </b> {username}\n"
    caption += f"<b> {almhebM}| الايـدي   ⇦ </b> <code>{user_id}</code>\n"
    caption += f"<b> {almhebM}| الرتبـــه  ⇦ {rotbat} </b>\n"
    caption += f"<b> {almhebM}| الصـور   ⇦ </b> {replied_user_profile_photos_count}\n"
    caption += f"<b> {almhebM}|الحسـاب ⇦ </b> "
    caption += f'<a href="tg://user?id={user_id}">{first_name}</a>'
    caption += f"\n<b> {almhebM}| الـمجموعات المشتـركة ⇦ </b> {common_chat} \n"
    caption += f"<b> {almhebM}| البايـو    ⇦ </b> {user_bio} \n"
    caption += f"<b> ٴ•━─━─━─━─━─━─━─━─━• </b>\n"
    caption += f"<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 almheb 𓆪 </b> - @E999G "
