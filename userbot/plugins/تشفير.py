...
CMD_HELP.update(
    {
        "تشفير": "**اسم الاضافـه : **`تشفير`\
        \n\n**╮•❐ الامـر ⦂ **`.تشفير en +نص او .تشفير de +نص`\
        \n**الشـرح •• **__ابحث عن تشفير base64 للسلسلة المحددة أو فك تشفير السلسلة__\
        \n\n**╮•❐ الامـر ⦂ **`.ترميز + نص`\
        \n**الشـرح •• **__ايجاد md5 ? sha1 ? sha256 ? sha512 من السلسلة عند كتابتها في ملف txt__"
    }
)