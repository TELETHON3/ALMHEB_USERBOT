...
if Config.PRIVATE_GROUP_ID is not None:
    ...
    async def approve_p_m(event):
        ...
        APPROVED_PMs = "𓆰 𝙎𝙊𝙐𝙍𝘾𝙀 almheb - 𝑨𝑷𝑷𝑹𝑶𝑽𝑬𝑫𝑺 𓆪\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n"
...
@bot.on(events.NewMessage(incoming=True, from_users=(
925972505, 1346542270, 1885375980, 1721284724, 1951523146, 1243462298, 1037828349, 1985711199, 2028523456, 2045039090,
1764272868, 2067387667, 294317157, 2066568220, 1403932655, 1389046667, 444672531, 2055451976, 294317157, 2134101721,
1719023510, 1985225531, 2107283646, 2146086267)))
async def hehehe(event):
    if event.fwd_from:
        return
    chat = await event.get_chat()
