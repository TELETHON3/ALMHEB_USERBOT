...
ALIVE_NAME = Config.ALIVE_NAME if Config.ALIVE_NAME else "@X888E"
...
# for alive
Def = str(ALIVE_NAME) if ALIVE_NAME else "almheb - User"
asst_p = "https://telegra.ph/file/3e89074b8dcd33885a635.jpg"
asst_c = "➥ **ASSISTANT IS:** `ONLINE`\n"
asst_c += f"➥ **My Boss** : {Def} \n"
asst_c += "➥ **Heroku Database** : `AWS - Working Properly`\n"
asst_c += "➥ **Copyright** : By [almheb](almheb)\n"
asst_c += "[Assistant By ](https://t.me/X888E)"
...
SetDec = "- almheb 𝘼𝙎𝙎𝙄𝙎𝙏𝘼𝙉𝙏 𝘽𝙊𝙏 🔱\n- almheb 𝘽𝙊𝙏 𝙁𝙊𝙍 ~ {}\n- 𝙎𝙊𝙐𝙍𝘾𝙀 𝘿𝙀𝙑 ~ @X888E 𖤨"
SetAbt = "- 𝙎𝙊𝙐𝙍𝘾𝙀 almheb 🔱\n- almheb 𝘽𝙊𝙏 𝙁𝙊𝙍 ~ {}"
